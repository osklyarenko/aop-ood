...
@Repository
public class HibernateBankingTransactionRepository extends HibernateDaoSupport
    implements BankingTransactionRepository {

  @Autowired
  public HibernateBankingTransactionRepository(SessionFactory sessionFactory) {
