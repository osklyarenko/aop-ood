...
import net.chrisrichardson.bankingExample.domain.hibernate.HibernateAccountPersistenceTests;
...
public class ManyAccountPersistenceTst {

    public static Test sweet() {
